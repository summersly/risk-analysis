// components/stomach-cards/four-items/four-items.js
import fourItemsModel from 'fourItemsModel'
Component({
  /**
   * 组件的属性列表
   */
  ...
  methods: {
    ...
    changeHPSelect: function (e) {
      this.setData({
        'hpModel.index': e.detail
      })
    },
    calcResult: function () {
      /**
      ...
      let hp = this.data.hpModel.index
      let riskResult = fourItemsModel.calculate(ageValue, pgrValue, g17Value, sex, hp)
      this.setData({
